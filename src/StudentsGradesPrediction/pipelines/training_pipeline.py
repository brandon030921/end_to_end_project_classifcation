from src.StudentsGradesPrediction.components.data_ingestion import DataIngestion

from src.StudentsGradesPrediction.components.data_transformation import DataTransformation
...
if __name__ == '__main__':
    ...
    trainingpipeline.start_trainig()
